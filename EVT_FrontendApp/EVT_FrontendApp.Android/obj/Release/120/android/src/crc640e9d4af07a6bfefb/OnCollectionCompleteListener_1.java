...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("EVT_FrontendApp.Droid.Services.ServiceListeners.OnCollectionCompleteListener`1, eVote", OnCollectionCompleteListener_1.class, __md_methods);
	}
	...
	public OnCollectionCompleteListener_1 ()
	{
		...
		if (getClass () == OnCollectionCompleteListener_1.class)
			mono.android.TypeManager.Activate ("EVT_FrontendApp.Droid.Services.ServiceListeners.OnCollectionCompleteListener`1, eVote", "", this, new java.lang.Object[] {  });
	}
